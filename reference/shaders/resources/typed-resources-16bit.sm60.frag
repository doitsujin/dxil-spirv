...
void main()
{
    ...
    SV_Target.w = ((((_185.w + (_179 + (_171 + (_130.w + _105.w)))) + _194.w) + _207.w) + _219.w) + _229.w;
    ...
    SV_Target_2.x = (_155.x + _123.x) + _248.x;
    SV_Target_2.y = (_155.y + _123.y) + _248.y;
    SV_Target_2.z = (_155.z + _123.z) + _248.z;
    SV_Target_2.w = (_155.w + _123.w) + _248.w;
}
